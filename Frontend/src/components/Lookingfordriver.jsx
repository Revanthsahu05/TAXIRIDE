...
//             <div>
//               <h3 className="font-semibold">{props.amt}</h3>
    ...
    <div className="p-4 relative">
      ...
      <div className="flex justify-center items-center mt-4 mb-6">
        <div className="animate-pulse">
          <img
            className="h-20 w-30"
            src={getVehicleImage(props.vechiletype)}
            alt="Uber vehicle"
          />
        </div>
      </div>
      ...
      <div className="flex flex-col items-center justify-center gap-3 pt-2">
        <div className="w-full flex items-center">
          <i className="ri-map-pin-user-fill text-2xl text-green-500 mr-3 mt-1"></i>
          <div>
            <h3 className="font-semibold">PICK UP</h3>
            <p className="text-gray-600">{props.pickup}</p>
          </div>
        ...
        <div className="w-full flex items-center mt-2">
          <i className="ri-map-pin-2-fill text-2xl text-red-500 mr-3 mt-1"></i>
          <div>
            <h3 className="font-semibold">DESTINATION</h3>
            <p className="text-gray-600">{props.destination}</p>
          </div>
        ...
        <div className="w-full flex items-center mt-2">
          <i className="ri-bank-card-fill text-2xl text-blue-500 mr-3 mt-1"></i>
          <div>
            <h3 className="font-semibold">₹{props.amt}</h3>
            <p className="text-gray-600">Total Amount</p>
          </div>
        ...
        <div className="mt-6 text-center">
          <p className="text-lg font-medium">Driver arriving </p>
          <p className="text-gray-500 text-sm">
            Hang tight! Looking for nearby drivers...
          </p>
        </div>
        {/* Cancel button */}
        <button
