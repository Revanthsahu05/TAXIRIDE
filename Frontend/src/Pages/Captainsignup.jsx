    ...
    <div className="p-4 bg-yellow-100 h-screen flex flex-col justify-between">
      ...
      <form onSubmit={submithandler}>
        <div className="flex justify-between ">
          <img src={home} alt="Home Icon" width={40} className="mb-4" />
          <img
      ...
      <div className="bg-[#d7e7a7] px-2 py-3 mt-4 w-full font-normal flex text-[10px] flex-col justify-center rounded">
