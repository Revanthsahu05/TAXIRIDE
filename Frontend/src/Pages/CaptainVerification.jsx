...
const CaptainVerification = () => {
    ...
    // Redirect back if no email logic (optional protection)
    if (!email) {
        navigate("/captain-signup", { replace: true });
        return null;
    }
    const submitHandler = async (e) => {
        ...
        setError('');
        try {
            const response = await axios.post(`${import.meta.env.VITE_BASE_URL}/captain/verify-otp`, {
                email,
                otp
            });
