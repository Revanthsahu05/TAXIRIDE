    ...
    <div className="p-4">
      <h3 className="p-1 text-center w-[81%] absolute top-0">
        <i
          ...
          onClick={() => {
            prps.setcrpanel(false);
          }}
        ></i>
      </h3>
      <h3 className="font-medium text-xl mb-3">Confirm your Ride</h3>
      <div className="flex flex-col items-center justify-center gap-3 pt-5">
        ...
        <button
          onClick={() => {
            prps.setvechilef(true);
            prps.setcrpanel(false);
          }}
          className="w-full text-white bg-yellow-500 rounded-sm font-medium p-1"
        >
          Confirm
        </button>
      </div>
...
export default Confirmridpanel;
