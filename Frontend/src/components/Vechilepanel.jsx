...
const Vechilepanel = (props) => {
  return (
    <div>
      ...
      {/* Conditionally render loader, error, or vehicle panel content */}
      {props.success === null ? (
        // Show loader while fare is being fetched
        <Loader />
      ) : props.success === false ? (
        // If fare calculation failed, show error page
        <ErrorPage
          setpanel={props.setpanel}
          setvechilepanel={props.setvechilepanel}
          setsuccess={props.setsuccess}
        />
      ) : (
        // Fare has been successfully fetched: show the vehicle selection content
        <>
          <h3>
            <i
              className="ri-arrow-down-wide-line absolute top-0 left-1/2 transform -translate-x-1/2 text-2xl font-semibold opacity-30 cursor-pointer"
              onClick={() => {
                if (props.vechilepanel) {
                  props.setpanel(true);
          ...
          <h3 className="font-medium text-xl mb-3">Choose a vehicle</h3>
          ...
          >
            ...
            <div className="mx-4">
              <div className="flex gap-2">
                <h4 className="font-medium text-lg">Taxi</h4>
                <span>
                  <i className="ri-user-fill text-xs">4</i>
                </span>
              </div>
          ...
          >
            ...
            <div className="mx-4">
              <div className="flex gap-2">
                <h4 className="font-medium text-lg">Moto</h4>
                <span>
                  <i className="ri-user-fill text-xs">1</i>
                </span>
              </div>
              <p className="font-medium text-xs text-gray-600">
                Affordable, Compact Rides
          ...
          >
            ...
            <div className="mx-4">
              <div className="flex gap-2">
                <h4 className="font-medium text-lg">Auto</h4>
                <span>
                  <i className="ri-user-fill text-xs">3</i>
                </span>
              </div>
              <p className="font-medium text-xs text-gray-600">
                Affordable, Compact Rides
